...
HD_PWD='c:/users/gcapo/documents/cese/05_mys/tf/ip_seno/ip_repo/edit_IP_seno_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IP_seno_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IP_seno_v1_0.tcl
