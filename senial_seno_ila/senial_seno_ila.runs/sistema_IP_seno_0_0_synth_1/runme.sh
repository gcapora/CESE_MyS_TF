...
HD_PWD='C:/Users/gcapo/Documents/CESE/05_MyS/TF/senial_seno_ila/senial_seno_ila.runs/sistema_IP_seno_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_IP_seno_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sistema_IP_seno_0_0.tcl
